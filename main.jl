...
import .DiffusionTensors: Dconst1D, Dlinear1D, Dquadratic1D, Dconst2D, Dlinear2D, Dquadratic2D, DmoroCardin, Doseen, DRinvertible
...
# Compute 2D probabilities
probabilities, x_bins, y_bins, n_bins = compute_2D_probabilities(potential, tau, xmin, ymin, xmax, ymax, n_bins)

# Run the experiments
@info "Running: $(exp_name)"
run_2D_experiment(integrators, num_repeats, potential, diffusion, T, tau, stepsizes, probabilities, x_bins, y_bins, n_bins; checkpoint=false)
